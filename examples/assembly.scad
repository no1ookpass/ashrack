...
//   openscad -o examples/assembly-1u-loop.png -D units=1 -D handle_sides="both" examples/assembly.scad
...
// Handles on the tray, or "none". The sides are named from the mounting edge.
handle_sides = "none";
